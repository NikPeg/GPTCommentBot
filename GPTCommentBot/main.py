...
if __name__ == "__main__":
    ...
    # bot.add_character("молодой рокер мотоциклист", config.ARTEM_TOKEN, messages.GPT_GIF_QUERY, 0.08)
    ...
    bot.add_character("ворчливый дед", config.MAX_TOKEN, messages.GPT_GIF_QUERY, 1.0)
    bot.start()
